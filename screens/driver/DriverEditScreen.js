...
export default class DriverEditScreen extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      firstname: "",
...
DriverEditScreen.navigationOptions = (navData) => {
  return {
...
const styles = StyleSheet.create({
  ...
  phone: { padding: 15, top: 60, backgroundColor: "#eaecf9", borderRadius: 10 },
  email: {
    color: "grey",
    width: 330,
    padding: 15,
